...
// @FIXME install  "@types/react-router": "2.4.0", when it will be published
...
declare module 'react-router' {
  ...
  import {
    ...
    BasenameOptions,
    QueryOptions
  } from '~react-router~history';

  module ReactRouter {

    type RouteConfig = Route | PlainRoute;

    type ReactComponent<IProps> = React.Component<IProps, any> | React.StatelessComponent<IProps>
      | React.ClassicComponent<IProps, any>;
    ...
    export interface IIndexRouteProps {
      ...
      getComponent?(
        location: Location,
        callback: ( error: Error, components: { [name: string]: ReactComponent<any> } ) => void
      ): void;
    ...
    type ChangeHook = (
      prevState: RouterState, nextState: RouterState, replace: RedirectFunction,
      callback?: Function
    ) => any;
    ...
    export function match(
      args: IMatchArgs,
      callback: ( error: Error, redirectLocation: Location, renderProps: Object ) => void
    ): void;
